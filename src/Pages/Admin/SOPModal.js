...
const SOPModal = ({ setIsModal, json, selName }) => {
  console.log(json);
  const ref = useRef();
  ...
  const onCapture = async () => {
    ...
    //문서저장
    doc.save("LearnMateAI-" + selName + "-" + json.date + ".pdf");
  };
      ...
      <Container>
        ...
        <Page>
          <div ref={ref}>
            ...
            <Section>
              <div className="info"># Learner : {selName}</div>
              <div className="info"># Date of creation : {json.date}</div>
            </Section>
            ...
            <Section>
              ...
              {/* {console.log(
                "## ",
                json.recommended_learning_materials !== undefined && "aa"
              )} */}
              {json.recommended_learning_materials !== undefined &&
